...
#Before submission run with and without unclassified lifestage removed for recruitment estimates ##Sara agrees. could say those unclassified were removed and assumed same C/Ad ratios as pop.
...
```{r filter, results='hide', message=FALSE, warning=FALSE}
herds <- treat.raw%>%
...
```{r survival prep, message=FALSE, warning=FALSE}
...
### Check quick
```{r check surv, message=FALSE, warning=FALSE}
...
```{r surv est, fig.height=10, fig.width=10, message=FALSE, warning=FALSE}
...
```{r surv est low samp, fig.height=10, fig.width=10, message=FALSE, warning=FALSE}
...
##Sex Ratios
```{r sex ratio, fig.height=10, fig.width=12, message=FALSE, warning=FALSE}
...
## Recruitment
```{r recruitment, fig.height=10, fig.width=10, message=FALSE, warning=FALSE}
...
## Counts
```{r counts, fig.height=10, fig.width=12, message=FALSE, warning=FALSE}
...
## Treatment
```{r treatment, fig.height=8, fig.width=12, message=FALSE, warning=FALSE}
...
```{r assess herds, results='hide', message=FALSE, warning=FALSE}
...
```{r data check, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
## Sample Sizes
```{r ss, message=FALSE, warning=FALSE}
##herds
nherd
