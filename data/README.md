...
\#Before submission run with and without unclassified lifestage removed
for recruitment estimates \##Sara agrees. could say those unclassified
were removed and assumed same C/Ad ratios as pop.
...
## Get survival data prepped

### in Eacker App format

``` r
unique(surv.raw$Outcome)
```

    ## [1] "Alive"     "Mortality" "Censored"

``` r
unique(surv.raw$`Sex (F, M)`)
```

    ## [1] "F"       "M"       "U"       "Unknown" "f"       NA

``` r
unique(surv.raw$Age.when.collard)
```

    ## [1] "Adult"   "Juv"     "Unknown" "Calf"
...
![](README_files/figure-gfm/check%20surv-1.png)<!-- -->

``` r
#summary(survfit(Surv(time, event) ~ herd, data = surv.yr), times = 360)
```

## Get frequentist survival
...
![](README_files/figure-gfm/surv%20est%20low%20samp-1.png)<!-- -->
...
![](README_files/figure-gfm/sex%20ratio-1.png)<!-- -->
...
![](README_files/figure-gfm/sex%20ratio-2.png)<!-- -->
...
![](README_files/figure-gfm/sex%20ratio-3.png)<!-- -->
...
![](README_files/figure-gfm/recruitment-1.png)<!-- -->
...
![](README_files/figure-gfm/recruitment-2.png)<!-- -->
...
![](README_files/figure-gfm/recruitment-3.png)<!-- -->
...
![](README_files/figure-gfm/recruitment-4.png)<!-- -->
...
![](README_files/figure-gfm/counts-1.png)<!-- -->
...
![](README_files/figure-gfm/counts-2.png)<!-- -->
...
![](README_files/figure-gfm/counts-3.png)<!-- -->
...
![](README_files/figure-gfm/treatment-1.png)<!-- -->

## Assess which herds we have data for
...
![](README_files/figure-gfm/assess%20herds-1.png)<!-- -->
...
## Output data by herd for data checking
